...
extern int register_android_util_gpioctrl(JNIEnv* env);
extern int register_android_util_gpiointerrup(JNIEnv* env);
extern int register_android_util_printers(JNIEnv* env);
...
static const RegJNIRec gRegJNI[] = {
    ...
    REG_JNI(register_android_util_gpioctrl),
    REG_JNI(register_android_util_gpiointerrup),
    REG_JNI(register_android_util_printers),
